...
//    最热栏目
     ...
     */
    public void setHomeHotColumn(List<HomeHotColumn> mHomeHotColumn) {
     ...
     */
    public void setFaceScoreColmun(List<HomeFaceScoreColumn> mHomeFaceScoreColumn) {
        this.mHomeFaceScoreColumn.clear();
        this.mHomeFaceScoreColumn.addAll(mHomeFaceScoreColumn);
        mFaceScoreColumnAdapter.setFaceScoreColumn(mHomeFaceScoreColumn);
        notifyDataSetChanged();
    }
     ...
     */
    public void setAllColumn(List<HomeRecommendHotCate> mHomeRecommendHotCate) {
    ...
    private void bindFaceScoreColumnHolder(ColumnViewHolder holder, int position, boolean isItem) {
        ...
        holder.rl_column_more.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtras(bundle);
                context.startActivity(intent);
                HomeRecommendFaceScoreActivity.start(context,holder.tv_column_name.getText().toString());
            }
        });
    }
