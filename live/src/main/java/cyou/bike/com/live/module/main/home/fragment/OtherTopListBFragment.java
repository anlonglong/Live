...
public class OtherTopListBFragment extends BaseFragment implements BaseQuickAdapter.OnItemClickListener {
    ...
    public static OtherTopListBFragment newInstance(List<HotCateBean.DataBean> list) {
        mOtherSectionList = list;
        OtherTopListBFragment fragment = new OtherTopListBFragment();
        return fragment;
    }
